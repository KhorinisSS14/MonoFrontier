...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU"; // KHR
        private const string FallbackCulture = "en-US"; // KHR
        ...
        public void Initialize()
        {
            ...
            var fallbackCulture = new CultureInfo(FallbackCulture); // KHR

            _loc.LoadCulture(culture);
            _loc.LoadCulture(fallbackCulture); // KHR
            _loc.SetFallbackCluture(fallbackCulture); // KHR
